<template>
   <div class="seller" ref="seller">
	   ...
	   <div class="overview">
		        ...
		        <!--收藏按钮-->
		        <div class="favorite">
		          <span class="icon-favorite" @click="toggleFavorite"><i class="iconfont icon-shoucang" :class="{'active':favorite}"></i></span>
...
<style>
@import url('//at.alicdn.com/t/font_443596_9sg44mxf04v4pldi.css');
.seller{
	position: absolute;
    top: 174px ;
    bottom: 0;
